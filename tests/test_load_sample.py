...
class TestLoadSample(TestCase):
    ...
    def test_load_sample_publishes_case_to_rabbit(self, patch_rabbit):
        sample_file = (
            ...
            'HTC_DIGITAL,FIELDCOORDINATOR_ID,FIELDOFFICER_ID,TREATMENT_CODE,CE_EXPECTED_CAPACITY,CE_SECURE',
            ...
            'E12000009,1,5,1,2,HH_LF3R2E,3,0',
            ...
            'E12000009,2,4,4,5,HH_LF3R3AE,6,0')
