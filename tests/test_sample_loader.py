...
class TestSampleLoader(TestCase):
    ...
    def test_load_sample_writes_attributes_to_redis(self, patch_redis, _):
        ...
        first_call_attributes = tuple(patch_redis_context_manager.set_names_to_values.call_args_list[0][0][0].values())[
            0]
        ...
        second_call_attributes = \
            tuple(patch_redis_context_manager.set_names_to_values.call_args_list[1][0][0].values())[0]
