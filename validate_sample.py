...
def load_sample(sample_file):
    ...
    for line_number, sample_row in enumerate(sample_file_reader, 2):
        ...
        validate_longitude_latitude(line_number, sample_row, 'LATITUDE', max_scale=9, max_precision=7)
        validate_longitude_latitude(line_number, sample_row, 'LONGITUDE', max_scale=10, max_precision=7)
